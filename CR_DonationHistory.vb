...
Public Class CR_DonationHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IT2A_DreamStashTest.CR_DonationHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DonationHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DonationHistory = New CR_DonationHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
