...
Public Class CR_Beneficiary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IT2A_DreamStashTest.CR_Beneficiary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Beneficiary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Beneficiary = New CR_Beneficiary()
        rpt.Site = Me.Site
        Return rpt
    End Function
