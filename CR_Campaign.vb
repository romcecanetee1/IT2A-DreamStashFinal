...
Public Class CR_Campaign
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IT2A_DreamStashTest.CR_Campaign.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Campaign
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Campaign = New CR_Campaign()
        rpt.Site = Me.Site
        Return rpt
    End Function
